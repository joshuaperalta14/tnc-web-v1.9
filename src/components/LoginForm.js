...
const LoginForm = () => {
  const handleGoogleSignIn = () => {
    // Handle Google Sign-In logic here, navigate to the Google Sign-In page or use Google's authentication library
    // For simplicity, let's assume navigating to '/google-signin' route for Google Sign-In page
    window.location.href = '/google-signin'; // Navigate to Google Sign-In page
  };
